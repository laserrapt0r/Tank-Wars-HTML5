...
addEventListener('mousedown', (e) => {
  ...
  // Do NOT release it here on the transient in-game screens (flight / rankings / help / status):
  // they all lead back to a cursor screen (shop / menu / aim), so releasing on the click that
  // advances them would drop the capture just as the shop opens. The lock is released only when
  // leaving the game (beginFarewell) or by the user pressing Esc.
